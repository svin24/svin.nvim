return { -- LSP Configuration & Plugins
  ...
  dependencies = {
    ...
    'saghen/blink.cmp',
    -- `lazydev` is here, treated as a dependency of the LSP setup
  ...
  config = function()
    ...
    -- Define the language servers to be installed and configured
    local servers = {
      clangd = {
        cmd = {
          'clangd',
    ...
    -- Setup mason so it can find and install binaries.
    require('mason').setup()
